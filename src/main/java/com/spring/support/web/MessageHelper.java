package com.spring.support.web;

import static com.spring.support.web.Message.MESSAGE_ATTRIBUTE;
...
public final class MessageHelper {
  ...
  private static void addAttribute(RedirectAttributes ra, String message, Message.Type type,
      Object... args) {
